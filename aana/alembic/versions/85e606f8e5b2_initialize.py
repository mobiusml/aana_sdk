...
Revision ID: 85e606f8e5b2
Revises: 
Create Date: 2024-06-12 12:27:33.474135
...
def upgrade() -> None:
    ...
    op.create_table(
        "media",
        sa.Column(
            "id", sa.String(), nullable=False, comment="Unique identifier for the media"
        ),
        sa.Column(
