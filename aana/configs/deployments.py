...
deployments = {
    ...
    "standard_concepts_v2_deployment": StandardConceptsV2Deployment.options(
        ...
        user_config=StandardConceptsV2Config(
            config_path="resources/deployments/standard_concepts_v2/config.yaml",
            model_path="resources/deployments/standard_concepts_v2/model.ts",
            keywords_path="resources/deployments/standard_concepts_v2/concepts.npy",
