...
endpoints = [
    ...
    {
        "name": "recognize_faces_video",
        "path": "/recognize_faces_video",
        "summary": "Detect and identify faces in video",
        "endpoint_cls": RecognizeFacesVideoEndpoint,  
    },
    {
