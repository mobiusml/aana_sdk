...
deployments = {
    ...
    "standard_concepts_v2_deployment": StandardConceptsV2Deployment.options(
        ...
        user_config=StandardConceptsV2Config(
            path_config="aana/resources/deployments/standard_concepts_v2/config.yaml",
            path_model="aana/resources/deployments/standard_concepts_v2/model.ts",
            path_keywords="aana/resources/deployments/standard_concepts_v2/concepts.npy",
            encoding_keywords="utf-8",
