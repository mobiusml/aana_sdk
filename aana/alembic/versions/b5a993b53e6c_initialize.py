...
def upgrade() -> None:
    ...
    sa.Column('video_id', sa.Integer(), nullable=True, comment='If media_type is `video`, the id of the video this entry represents.'),
    ...
    sa.Column('media_id', sa.String(), nullable=False, comment='Foreign key to media table'),
    sa.Column('video_id', sa.Integer(), nullable=False, comment='Foreign key to video table'),
